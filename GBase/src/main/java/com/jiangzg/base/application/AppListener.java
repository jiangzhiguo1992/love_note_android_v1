...
public class AppListener {
    ...
    public static void addComponentListener(String tag, ComponentListener listener) {
        if (StringUtils.isEmpty(tag) || listener == null) {
            LogUtils.w(LOG_TAG, "addComponentListener: tag == null || listener == null");
            return;
        }
    ...
    public static void removeComponentListener(String tag) {
        if (StringUtils.isEmpty(tag)) {
            LogUtils.w(LOG_TAG, "removeComponentListener: tag == null");
            return;
        }
    ...
    public static void addActivityListener(String tag, ActivityListener listener) {
        if (StringUtils.isEmpty(tag) || listener == null) {
            LogUtils.w(LOG_TAG, "addActivityListener: tag == null || listener == null");
            return;
        }
    ...
    public static void removeActivityListener(String tag) {
        if (StringUtils.isEmpty(tag)) {
            LogUtils.w(LOG_TAG, "removeActivityListener: tag == null");
            return;
        }
    ...
    public static void initApp(Application app) {
        if (app == null) {
            LogUtils.w(LOG_TAG, "initApp: app == null");
            return;
        }
        app.registerComponentCallbacks(new ComponentCallbacks2() {
            ...
            public void onTrimMemory(int level) {
                for (Map.Entry<String, ComponentListener> entry : componentListener.entrySet()) {
                    ...
                    LogUtils.i(LOG_TAG, "onTrimMemory-->" + key);
            ...
            public void onConfigurationChanged(Configuration newConfig) {
                for (Map.Entry<String, ComponentListener> entry : componentListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onConfigurationChanged-->" + key);
            ...
            public void onLowMemory() {
                for (Map.Entry<String, ComponentListener> entry : componentListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onLowMemory-->" + key);
        ...
        app.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivityCreated-->" + key);
            ...
            public void onActivityStarted(Activity activity) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivityStarted-->" + key);
            ...
            public void onActivityResumed(Activity activity) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivityResumed-->" + key);
            ...
            public void onActivityPaused(Activity activity) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivityPaused-->" + key);
            ...
            public void onActivityStopped(Activity activity) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivityStopped-->" + key);
            ...
            public void onActivitySaveInstanceState(Activity activity, Bundle outState) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivitySaveInstanceState-->" + key);
            ...
            public void onActivityDestroyed(Activity activity) {
                for (Map.Entry<String, ActivityListener> entry : activityListener.entrySet()) {
                    String key = entry.getKey();
                    LogUtils.i(LOG_TAG, "onActivityDestroyed-->" + key);
