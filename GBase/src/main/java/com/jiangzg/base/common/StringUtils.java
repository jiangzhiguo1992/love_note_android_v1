...
public class StringUtils {
    ...
    public static boolean isPostCode(String postCode) {
        return isMatch(ConstantUtils.REGEX_POST_CODE, postCode);
    }
    ...
    public static boolean isNumber(String src) {
        return isMatch(ConstantUtils.REGEX_NUMBER, src);
    }
    ...
    public static boolean isPassword(String password) {
        return isMatch(ConstantUtils.REGEX_PASSWORD, password);
    }
    ...
    public static boolean isIDCard15(String string) {
        return isMatch(ConstantUtils.REGEX_IDCARD15, string);
    }
    ...
    public static boolean isIDCard18(String string) {
        return isMatch(ConstantUtils.REGEX_IDCARD18, string);
    }
    ...
    public static boolean isEmail(String string) {
        return isMatch(ConstantUtils.REGEX_EMAIL, string);
    }
    ...
    public static boolean isDate(String string) {
        return isMatch(ConstantUtils.REGEX_DATE, string);
    }
    ...
    public static boolean isCN(String string) {
        return isMatch(ConstantUtils.REGEX_CHZ, string);
    }
    ...
    public static boolean isURL(String string) {
        return isMatch(ConstantUtils.REGEX_URL, string);
    }
    ...
    public static boolean isMobile(String string) {
        return isMatch(ConstantUtils.REGEX_MOBILE, string);
    }
    ...
    public static boolean isTel(String string) {
        return isMatch(ConstantUtils.REGEX_TEL, string);
    }
