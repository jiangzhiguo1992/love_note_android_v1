...
public class HelpActivity extends BaseActivity<HelpActivity> {
    ...
    private Help getHelpNoteMenses(int index) {
        ...
        contentList.add(c3);
        Help.HelpContent c4 = new Help.HelpContent();
        c4.setQuestion(getString(R.string.help_note_menses_c4_q));
        c4.setAnswer(getString(R.string.help_note_menses_c4_a));
        contentList.add(c4);
        help.setContentList(contentList);
        return help;
    }
    ...
    private Help getHelpNoteWhisper(int index) {
        ...
        contentList.add(c3);
        Help.HelpContent c4 = new Help.HelpContent();
        c4.setQuestion(getString(R.string.help_note_whisper_c4_q));
        c4.setAnswer(getString(R.string.help_note_whisper_c4_a));
        contentList.add(c4);
        help.setContentList(contentList);
        return help;
    }
    ...
    private Help getHelpNoteAward(int index) {
        ...
        contentList.add(c3);
        Help.HelpContent c4 = new Help.HelpContent();
        c4.setQuestion(getString(R.string.help_note_award_c4_q));
        c4.setAnswer(getString(R.string.help_note_award_c4_a));
        contentList.add(c4);
        help.setContentList(contentList);
        return help;
    }
