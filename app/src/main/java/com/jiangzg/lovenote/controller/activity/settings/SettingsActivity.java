...
public class SettingsActivity extends BaseActivity<SettingsActivity> {
    ...
    protected void initData(Intent intent, Bundle state) {
        // 恋爱吧开关
        switchTopic.setChecked(SPHelper.getSettingsTopicModel());
        // 缓存大小
        cacheShow();
        // 系统通知
    ...
    @OnClick({R.id.tvTheme, R.id.rlTopic, R.id.rlCache,
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.tvTheme: // 主题
                ...
                break;
            case R.id.rlTopic:// 恋爱吧
                switchTopic.setChecked(!switchTopic.isChecked());
                break;
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        switch (buttonView.getId()) {
            case R.id.switchTopic: // 恋爱吧
                SPHelper.setSettingsTopicModel(isChecked);
                RxBus.post(new RxBus.Event<>(RxBus.EVENT_SETTINGS_TOPIC_MODEL, isChecked));
                break;
