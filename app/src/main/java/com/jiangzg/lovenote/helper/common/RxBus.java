...
public class RxBus {
    ...
    // settings
    public static final int EVENT_SETTINGS_TOPIC_MODEL = 1100; // 恋爱吧
    public static final int EVENT_SUGGEST_LIST_REFRESH = 1200; // 建议
    public static final int EVENT_SUGGEST_LIST_ITEM_DELETE = 1201;
    public static final int EVENT_SUGGEST_LIST_ITEM_REFRESH = 1202;
    public static final int EVENT_SUGGEST_DETAIL_REFRESH = 1203;
    // user
