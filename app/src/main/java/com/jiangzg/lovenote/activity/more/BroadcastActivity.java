...
public class BroadcastActivity extends BaseActivity<BroadcastActivity> {
    ...
    protected void initView(Intent intent, Bundle state) {
        ...
        String start = broadcast.getStartAt() == 0 ? getString(R.string.nil) : TimeHelper.getTimeShowCn_HM_MD_YMD_ByGo(broadcast.getStartAt());
        String startShow = String.format(Locale.getDefault(), getString(R.string.start_time_colon_holder), start);
        String end = broadcast.getEndAt() == 0 ? getString(R.string.nil) : TimeHelper.getTimeShowCn_HM_MD_YMD_ByGo(broadcast.getEndAt());
