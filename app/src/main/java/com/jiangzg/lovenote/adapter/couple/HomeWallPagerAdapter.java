 ...
 */
public class HomeWallPagerAdapter extends PagerAdapter {
    ...
    public HomeWallPagerAdapter(Context context, ViewPager pager) {
        mContext = context;
            ...
            public void run() {
                MyApp.get().getHandler().post(() -> {
                    ...
                    if (child != null) {
                        ...
                        LogUtils.w(HomeWallPagerAdapter.class, "startAutoNext", "child == null");
                    }
                });
            }
        }, 10000, 10000);
