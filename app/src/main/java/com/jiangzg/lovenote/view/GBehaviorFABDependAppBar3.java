 ...
 * 跟随appBar一起消失
 */
public class GBehaviorFABDependAppBar3 extends CoordinatorLayout.Behavior<FloatingActionButton> {

    public GBehaviorFABDependAppBar3(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
