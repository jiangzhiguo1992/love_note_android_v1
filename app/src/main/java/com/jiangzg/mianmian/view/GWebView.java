...
public class GWebView extends WebView {
    ...
    private String cacheDir; // TODO 加到resHelper
    ...
    private void init(Context context) {
        ...
        this.setViewClient(webViewClient);
        this.setChromeClient(webChromeClient);
    }
    ...
    public void addJs(Object jsInterface, String name) {
        this.addJavascriptInterface(jsInterface, name);
    }
    ...
    public void setZoom(int scale) {
        this.setInitialScale(scale); // 25最小缩放等级
    }
    ...
    public void setTextZoom(int size) {
        this.getSettings().setTextZoom(size); // WebSettings.TextSize.LARGER.ordinal()
    }
