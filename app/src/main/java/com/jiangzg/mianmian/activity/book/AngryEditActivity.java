...
public class AngryEditActivity extends BaseActivity<AngryEditActivity> {
    ...
    private void showDatePicker() {
        Calendar calendar = DateUtils.getCalendar(TimeHelper.getJavaTimeByGo(angry.getHappenAt()));
        ...
        DatePickerDialog picker = new DatePickerDialog(mActivity, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                angry.setHappenAt(TimeHelper.getGoTimeByJava(instance.getTimeInMillis()));
                refreshDateView();
            }
        }, year, month, day);
        picker.show();
    ...
    private void refreshDateView() {
        String happen = TimeHelper.getTimeShowCnSpace_HM_MD_YMD_ByGo(angry.getHappenAt());
